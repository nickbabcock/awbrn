...
pub(crate) fn add_terrain_to_board_index(
...
pub(crate) fn remove_terrain_from_board_index(
    mut world: DeferredWorld,
    entity: Entity,
    position: Position,
) {
...
pub(crate) fn add_unit_to_board_index(
    mut world: DeferredWorld,
    entity: Entity,
    position: Position,
) {
...
pub(crate) fn remove_unit_from_board_index(
    mut world: DeferredWorld,
    entity: Entity,
    position: Position,
) {
...
mod tests {
    use super::*;
    use crate::core::map::{GameMap, TerrainTile, initialize_terrain_semantic_world};
    use crate::core::{MapPosition, Unit};
    ...
    fn board_index_updates_when_unit_map_position_changes_or_is_removed() {
        ...
        let entity = app
            .world_mut()
            .spawn((MapPosition::from(start), Unit(awbrn_core::Unit::Infantry)))
            .id();
