    ...
    match terrain {
        ...
        GraphicalTerrain::Terrain(terrain) => match terrain {
            ...
            Terrain::River(river_type) => match river_type {
                ...
                RiverType::SW => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::River(RiverType::NES))).following(1),
                RiverType::SWN => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::River(RiverType::SW))).following(1),
                RiverType::Vertical => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::River(RiverType::SWN))).following(1),
                RiverType::WN => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::River(RiverType::Vertical))).following(1),
                RiverType::WNE => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::River(RiverType::WN))).following(1),
            },
            Terrain::Road(road_type) => match road_type {
                RoadType::Cross => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::River(RiverType::WNE))).following(1),
                ...
                RoadType::Horizontal => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::ESW))).following(1),
                RoadType::NE => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Bridge(BridgeType::Horizontal))).following(1),
                RoadType::NES => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::NE))).following(1),
                RoadType::SW => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::NES))).following(1),
                RoadType::SWN => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::SW))).following(1),
                RoadType::Vertical => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::SWN))).following(1),
                RoadType::WN => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Bridge(BridgeType::Vertical))).following(1),
                RoadType::WNE => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::WN))).following(1),
            },
            Terrain::Bridge(bridge_type) => match bridge_type {
                BridgeType::Horizontal => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::Horizontal))).following(1),
                BridgeType::Vertical => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::Vertical))).following(1),
            },
            ...
            Terrain::Property(property) => match property {
                ...
                Property::Airport(Faction::Player(PlayerFaction::AcidRain)) => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Wood)).following(3),
                ...
                Property::Airport(Faction::Player(PlayerFaction::SilverClaw)) => match weather {
                    ...
                    Weather::Rain | Weather::Snow => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Road(RoadType::WNE))).following(3),
                },
            ...
            Terrain::Pipe(pipe_type) => match pipe_type {
                ...
                PipeType::NE => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Pipe(PipeType::Horizontal))).following(1),
                PipeType::NorthEnd => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Pipe(PipeType::NE))).following(1),
                PipeType::SouthEnd => spritesheet_index(weather, GraphicalTerrain::Terrain(Terrain::Pipe(PipeType::NorthEnd))).following(1),
