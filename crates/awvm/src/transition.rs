...
pub fn begin_match(state: &State, random: &[RandomToken]) -> Result<Execution, ExecuteError> {
...
mod tests {
    ...
    use crate::semantic::{
        ...
        PlayerStatus, Reason, ReasonId, Silo, Tile, TileOwner, UnitAction, VictoryReason,
        Visibility,
    };
