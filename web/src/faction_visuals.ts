...
export const FACTION_COLORS = {
  os: {
    accent: "#ff4f4e",
    accentSoft: "rgba(255, 79, 78, 0.22)",
    text: "#923243",
    wash: "rgba(255, 79, 78, 0.18)",
  },
  bm: {
    accent: "#94a2fd",
    accentSoft: "rgba(112, 140, 254, 0.24)",
    text: "#466efe",
    wash: "rgba(112, 140, 254, 0.2)",
  },
  ge: {
    accent: "#87e287",
    accentSoft: "rgba(97, 208, 90, 0.22)",
    text: "#3dc22d",
    wash: "rgba(97, 208, 90, 0.18)",
  },
  yc: {
    accent: "#f0d204",
    accentSoft: "rgba(240, 210, 4, 0.24)",
    text: "#9f8f00",
    wash: "rgba(240, 210, 4, 0.2)",
  },
  bh: {
    accent: "#bbb4a5",
    accentSoft: "rgba(116, 89, 138, 0.24)",
    text: "#74598a",
    wash: "rgba(116, 89, 138, 0.18)",
  },
  rf: {
    accent: "#c27184",
    accentSoft: "rgba(194, 113, 132, 0.24)",
    text: "#b52744",
    wash: "rgba(194, 113, 132, 0.2)",
  },
  gs: {
    accent: "#979797",
    accentSoft: "rgba(151, 151, 151, 0.22)",
    text: "#727272",
    wash: "rgba(151, 151, 151, 0.18)",
  },
  bd: {
    accent: "#ad7e5f",
    accentSoft: "rgba(173, 126, 95, 0.24)",
    text: "#985333",
    wash: "rgba(173, 126, 95, 0.2)",
  },
  ab: {
    accent: "#fec078",
    accentSoft: "rgba(254, 192, 120, 0.26)",
    text: "#fca339",
    wash: "rgba(254, 192, 120, 0.22)",
  },
  js: {
    accent: "#c4d7b4",
    accentSoft: "rgba(196, 215, 180, 0.24)",
    text: "#6f7b67",
    wash: "rgba(196, 215, 180, 0.2)",
  },
  ci: {
    accent: "#2342ba",
    accentSoft: "rgba(35, 66, 186, 0.24)",
    text: "#0b2070",
    wash: "rgba(35, 66, 186, 0.2)",
  },
  pc: {
    accent: "#ff99cc",
    accentSoft: "rgba(255, 153, 204, 0.22)",
    text: "#ff66cc",
    wash: "rgba(255, 153, 204, 0.18)",
  },
  tg: {
    accent: "#6cd9d0",
    accentSoft: "rgba(108, 217, 208, 0.24)",
    text: "#3ccdc1",
    wash: "rgba(108, 217, 208, 0.2)",
  },
  pl: {
    accent: "#a447d3",
    accentSoft: "rgba(164, 71, 211, 0.24)",
    text: "#6f1a9b",
    wash: "rgba(164, 71, 211, 0.2)",
  },
  ar: {
    accent: "#7a9d11",
    accentSoft: "rgba(122, 157, 17, 0.26)",
    text: "#617c0e",
    wash: "rgba(122, 157, 17, 0.22)",
  },
  wn: {
    accent: "#d4bf9f",
    accentSoft: "rgba(212, 191, 159, 0.24)",
    text: "#cd9b9a",
    wash: "rgba(212, 191, 159, 0.2)",
  },
  aa: {
    accent: "#84dfe8",
    accentSoft: "rgba(132, 223, 232, 0.24)",
    text: "#3a9ee6",
    wash: "rgba(132, 223, 232, 0.2)",
  },
  ne: {
    accent: "#6e6060",
    accentSoft: "rgba(110, 96, 96, 0.24)",
    text: "#2e2626",
    wash: "rgba(110, 96, 96, 0.2)",
  },
  sc: {
    accent: "#8cacbc",
    accentSoft: "rgba(140, 172, 188, 0.26)",
    text: "#3d6479",
    wash: "rgba(140, 172, 188, 0.22)",
  },
  uw: {
    accent: "#d47700",
    accentSoft: "rgba(212, 119, 0, 0.24)",
    text: "#854000",
...
const FALLBACK_VISUAL = {
  accent: "#8a7860",
  accentSoft: "rgba(138, 120, 96, 0.2)",
  text: "#5a4a38",
