/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareBindings` (hash: e652ec346ab3a14f8641f05a03bbc62c)
// Runtime types generated with workerd@1.20260409.1 2025-09-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "MatchDurableObject";
	}
	interface Env {
		DB: D1Database;
