/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: c8f43388040667a0efe096b5826941aa)
// Runtime types generated with workerd@1.20260825.1 2025-09-24 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	CONTENT: R2Bucket;
	DB: D1Database;
	CREATE_MATCH_RATE_LIMITER: RateLimit;
	IMPORT_MAP_RATE_LIMITER: RateLimit;
	LOBBY_WRITE_RATE_LIMITER: RateLimit;
	AWBW_ACTOR_RATE_LIMITER: RateLimit;
	WS_UPGRADE_RATE_LIMITER: RateLimit;
	PUSH_SUBSCRIBE_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	...
	MATCHES: DurableObjectNamespace<import("./src/server").MatchDurableObject>;
	AWBW_GATEWAY: DurableObjectNamespace<import("./src/server").AwbwGatewayDurableObject>;
	MATCHMAKERS: DurableObjectNamespace<import("./src/server").MatchmakerDurableObject>;
	PLAYERS: DurableObjectNamespace<import("./src/server").PlayerDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "MatchDurableObject" | "AwbwGatewayDurableObject" | "MatchmakerDurableObject" | "PlayerDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_URL" | "AUTH_SECRET" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT">> {}
}
