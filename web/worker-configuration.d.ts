/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 2ccab1e41b2ad4129087e5e9e659d25f)
...
interface __BaseEnv_CloudflareBindings {
	...
	RATINGS: DurableObjectNamespace<import("./src/server").RatingsDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "MatchDurableObject" | "AwbwGatewayDurableObject" | "MatchmakerDurableObject" | "PlayerDurableObject" | "RatingsDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_URL" | "AUTH_SECRET">> {}
}
